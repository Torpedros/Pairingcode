   ...
   return this.sendMessage(jid, await conv.sticker(medias.data, null, opts.packname || 'Whatsapp Bot', opts.author || conn.user.name), 'stickerMessage', { quoted: m, ...opts })
        ...
        sendFile: {
            ...
            async value(jid, path, filename = '', caption = '', quoted, ptt = false, options = {}) {
                ...
                if (fileSize >= 100) throw new Error('Tidak Bisa mendownload File Ukuran File Terlalu Besar !')
                let opt = {}
            ...
            return conn.generateMessage(jid, {
               ...
               contextInfo: {
                  ...
                  externalAdReply: {
                     ...
                     sourceUrl: properties.url || 'https://chat.whatsapp.com/KVh0rVBueteHbeqY1RkDoB'
		  },
